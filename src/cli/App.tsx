  ...
  const onSubmit = useCallback(
    async (message?: string): Promise<{ submitted: boolean }> => {
      ...
      if (aliasedMsg.startsWith("/")) {
        ...
        if (trimmed === "/ade") {
          const adeUrl = conversationIdRef.current === "default" ? `https://app.letta.com/agents/${agentId}?conversation=${conversationIdRef.current}` : `https://app.letta.com/agents/${agentId}?conversation=${conversationIdRef.current}`;
