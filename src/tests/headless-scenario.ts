...
function scenarioPrompt(): string {
  return (
    ...
    "First, use the Read tool to read the file 'package.json'. " +
    "Then, try calling Read twice in parallel to read 'package.json' and 'tsconfig.json'. " +
    ...
    "Then finally, try running 2 shell commands and 1 Read in parallel (echo 'Final1', echo 'Final2', and read 'package.json'), so three parallel tools. " +
