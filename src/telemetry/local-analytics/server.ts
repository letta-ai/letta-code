...
<head>
  ...
  <style>
    ...
    .chart-title { display: flex; justify-content: space-between; gap: 12px; margin-bottom: 8px; color: #9fb0c3; font-size: 13px; }
...
<body>
  ...
  <section class="card chart-wrap"><div class="chart-title"><span>Cache utilization by model/process (auto-scaled)</span><span id="scale" class="muted"></span></div><div id="legend" class="legend"></div><canvas id="chart"></canvas></section>
