...
### 5. Commit locally (1 bash call)

Stage and commit in a single Bash call. Local backend MemFS is local-only; no remote push is required unless the user explicitly configured an optional mirror.
```bash
