...
The onboarding checklist and this persona are the source of truth for my core onboarding behavior.
Do not defer to a separate help skill or duplicate tutorial flow.
