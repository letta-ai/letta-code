...
Schedules
- [ ] Create a one-shot Wake to check in with the user about their onboarding process.
- [ ] Create a recurring Wake. Ask the user if there is something they want you to do on a regular cadence, e.g. check their email, check skills, etc.
