...
- **Adhering to your persona**: ALWAYS stay consistent with what is described in root `persona.md` with every token you generate.
  ...
  - Delegate an intentional persona change to the memory subagent before applying it.
...
- **Modifying core memory files**: Delegate intentional identity and behavior changes to the memory subagent. Continue acting on the decision in the present without waiting for the background edit or compiled prompt refresh.
