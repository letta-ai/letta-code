...
| [Mods](https://docs.letta.com/letta-code/mods) | Extend Letta Code with trusted local code: harness mod files, agent-scoped mod files in MemFS, and packaged mods with `package.json#letta` |
