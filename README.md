...
Letta Code is a memory-first coding harness, built on top of the Letta API. Rather than working in ephemeral sessions, you work with a persisted agent which learns over time and can switch between models (Claude Sonnet/Opus, GPT-5, Gemini 3 Pro, GLM-4.6, and more).  
